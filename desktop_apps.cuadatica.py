...
def borrar():
    ...
    b.set("")
    c.set("")
    t_resultados.delete("1.0", END)  # Corregido: END sin comillas
...
def resolver():
    ...
    # 2. Intentar convertir a números (Evita que el programa se caiga si escriben letras)
    try:
...
entry_a.focus_set()
entry_a.place(x=200, y=90, width=120, height=30)
...
entry_b.place(x=200, y=135, width=120, height=30)
...
entry_c.place(x=200, y=180, width=120, height=30)
